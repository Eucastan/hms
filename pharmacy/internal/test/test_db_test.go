...
func SetupTestDB(t *testing.T) *gorm.DB {
	...
	container, err := tcpostgres.Run(ctx,
		"postgres:15-alpine",
		tcpostgres.WithDatabase("pharmacy_test_db"),
	...
	err = db.AutoMigrate(&models.Dispense{}, &models.Drug{}, &models.Prescription{})
	require.NoError(t, err, "failed to migrate schema")

	t.Cleanup(func() {
		db.Exec("TRUNCATE TABLE dispenses, drugs, prescriptions RESTART IDENTITY CASCADE")
	})
