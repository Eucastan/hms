...
func SetupTestDB(t *testing.T) *gorm.DB {
	...
	container, err := tcpostgres.Run(ctx,
		"postgres:15-alpine",
		tcpostgres.WithDatabase("payment_test_db"),
	...
	err = db.AutoMigrate(&models.Invoice{}, &models.BillCharge{}, &models.Payment{})
	require.NoError(t, err, "failed to migrate schema")

	t.Cleanup(func() {
		db.Exec("TRUNCATE TABLE invoices, bill_charges, payments RESTART IDENTITY CASCADE")
	})
